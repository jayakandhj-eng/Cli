...
type CustomName struct {
	DbHost         string `env:"db.host,default=NEXT_PUBLIC_Indobase_URL"`
	DbPassword     string `env:"db.password,default=Indobase_DB_PASSWORD"`
	JWTSecret      string `env:"db.password,default=Indobase_AUTH_JWT_SECRET"`
	AnonKey        string `env:"auth.anon_key,default=Indobase_AUTH_ANON_KEY"`
	ServiceRoleKey string `env:"auth.service_role_key,default=Indobase_AUTH_SERVICE_ROLE_KEY"`
}
