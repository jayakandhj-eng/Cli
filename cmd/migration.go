...
import (
	...
	"github.com/Indobase/cli/internal/migration/fetch"
	...
	"github.com/Indobase/cli/internal/migration/squash"
	"github.com/Indobase/cli/internal/migration/up"
...
var (
	...
	migrationRepairCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("Indobase migration repair") + ".")
		},
	}
	...
	migrationSquashCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("Indobase migration squash") + ".")
		},
	}
