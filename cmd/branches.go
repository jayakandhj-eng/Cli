...
import (
	...
	"github.com/Indobase/cli/internal/branches/create"
	"github.com/Indobase/cli/internal/branches/delete"
	"github.com/Indobase/cli/internal/branches/disable"
	"github.com/Indobase/cli/internal/branches/get"
	"github.com/Indobase/cli/internal/branches/list"
	"github.com/Indobase/cli/internal/branches/pause"
	"github.com/Indobase/cli/internal/branches/unpause"
	"github.com/Indobase/cli/internal/branches/update"
...
var (
	branchesCmd = &cobra.Command{
		...
		Use:     "branches",
		Short:   "Manage Indobase preview branches",
	}
...
func init() {
	...
	branchFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
...
func promptBranchId(ctx context.Context, fsys afero.Fs) error {
	...
	if err != nil {
		...
		utils.CmdSuggestion = fmt.Sprintf("Create your first branch with: %s", utils.Aqua("Indobase branches create"))
