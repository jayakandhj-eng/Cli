...
import (
	...
	"github.com/Indobase/cli/internal/snippets/download"
	"github.com/Indobase/cli/internal/snippets/list"
...
var (
	snippetsCmd = &cobra.Command{
		...
		Use:     "snippets",
		Short:   "Manage Indobase SQL snippets",
	}
...
func init() {
	snippetsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
