...
var (
	...
	linkCmd = &cobra.Command{
		...
		Use:     "link",
		Short:   "Link to a Indobase project",
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Fprintln(os.Stdout, "Finished "+utils.Aqua("Indobase link")+".")
		},
	}
)
...
func init() {
	...
	linkFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
