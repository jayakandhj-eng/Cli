...
import (
	...
	"github.com/Indobase/cli/internal/vanity_subdomains/activate"
	"github.com/Indobase/cli/internal/vanity_subdomains/check"
	"github.com/Indobase/cli/internal/vanity_subdomains/delete"
	"github.com/Indobase/cli/internal/vanity_subdomains/get"
)
...
var (
	vanityCmd = &cobra.Command{
		...
		Short:   "Manage vanity subdomains for Indobase projects",
		Long: `Manage vanity subdomains for Indobase projects.
...
Usage of vanity subdomains and custom domains is mutually exclusive.`,
	...
	vanityActivateCmd = &cobra.Command{
		...
		Long: `Activate a vanity subdomain for your Indobase project.

This reconfigures your Indobase project to respond to requests on your vanity subdomain.
After the vanity subdomain is activated, your project's auth services will no longer function on the {project-ref}.{Indobase-domain} hostname.
`,
...
func init() {
	vanityCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
	vanityActivateCmd.Flags().StringVar(&desiredSubdomain, "desired-subdomain", "", "The desired vanity subdomain to use for your Indobase project.")
	cobra.CheckErr(vanityActivateCmd.MarkFlagRequired("desired-subdomain"))
	vanityCheckCmd.Flags().StringVar(&desiredSubdomain, "desired-subdomain", "", "The desired vanity subdomain to use for your Indobase project.")
