...
import (
	...
	"github.com/Indobase/cli/internal/restrictions/get"
	"github.com/Indobase/cli/internal/restrictions/update"
...
func init() {
	restrictionsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
