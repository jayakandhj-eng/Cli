...
import (
	...
	"github.com/Indobase/cli/internal/sso/create"
	"github.com/Indobase/cli/internal/sso/get"
	"github.com/Indobase/cli/internal/sso/info"
	"github.com/Indobase/cli/internal/sso/list"
	"github.com/Indobase/cli/internal/sso/remove"
	"github.com/Indobase/cli/internal/sso/update"
...
var (
	...
	ssoAddCmd = &cobra.Command{
		...
		Long:    "Add and configure a new connection to a SSO identity provider to your Indobase project.",
		Example: `  Indobase sso add --type saml --project-ref mwjylndxudmiehsxhmmz --metadata-url 'https://...' --domains example.com`,
	...
	ssoRemoveCmd = &cobra.Command{
		...
		Example: `  Indobase sso remove b5ae62f9-ef1d-4f11-a02b-731c8bbb11e8 --project-ref mwjylndxudmiehsxhmmz`,
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	ssoUpdateCmd = &cobra.Command{
		...
		Args:    cobra.ExactArgs(1),
		Example: `  Indobase sso update b5ae62f9-ef1d-4f11-a02b-731c8bbb11e8 --project-ref mwjylndxudmiehsxhmmz --add-domains example.com`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if !utils.UUIDPattern.MatchString(args[0]) {
				return errors.Errorf("identity provider ID %q is not a UUID", args[0])
			}
	...
	ssoShowCmd = &cobra.Command{
		...
		Args:    cobra.ExactArgs(1),
		Example: `  Indobase sso show b5ae62f9-ef1d-4f11-a02b-731c8bbb11e8 --project-ref mwjylndxudmiehsxhmmz`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if !utils.UUIDPattern.MatchString(args[0]) {
				return errors.Errorf("identity provider ID %q is not a UUID", args[0])
			}
	...
	ssoListCmd = &cobra.Command{
		...
		Long:    "List all connections to a SSO identity provider to your Indobase project.",
		Example: `  Indobase sso list --project-ref mwjylndxudmiehsxhmmz`,
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	ssoInfoCmd = &cobra.Command{
		...
		Example: `  Indobase sso info --project-ref mwjylndxudmiehsxhmmz`,
		RunE: func(cmd *cobra.Command, args []string) error {
