...
import (
	...
	"github.com/Indobase/cli/internal/gen/bearerjwt"
	"github.com/Indobase/cli/internal/gen/signingkeys"
	"github.com/Indobase/cli/internal/gen/types"
	"github.com/Indobase/cli/internal/utils"
	"github.com/Indobase/cli/internal/utils/flags"
	"github.com/Indobase/cli/legacy/keys"
...
var (
	...
	genTypesCmd = &cobra.Command{
		...
		Example: `  Indobase gen types --local
  Indobase gen types --linked --lang=go
  Indobase gen types --project-id abc-def-123 --schema public --schema private
  Indobase gen types --db-url 'postgresql://...' --schema public --schema auth`,
	}
...
func init() {
	...
	keyFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
