...
import (
	...
	"github.com/Indobase/cli/internal/functions/delete"
	"github.com/Indobase/cli/internal/functions/deploy"
	"github.com/Indobase/cli/internal/functions/download"
	"github.com/Indobase/cli/internal/functions/list"
	new_ "github.com/Indobase/cli/internal/functions/new"
...
var (
	functionsCmd = &cobra.Command{
		...
		Use:     "functions",
		Short:   "Manage Indobase Edge functions",
	}

	functionsListCmd = &cobra.Command{
		Use:   "list",
		Short: "List all Functions in Indobase",
		Long:  "List all Functions in the linked Indobase project.",
	...
	functionsDeleteCmd = &cobra.Command{
		...
		Short: "Delete a Function from Indobase",
		Long:  "Delete a Function from the linked Indobase project. This does NOT remove the Function locally.",
	...
	functionsDownloadCmd = &cobra.Command{
		...
		Short: "Download a Function from Indobase",
		Long:  "Download the source code for a Function from the linked Indobase project. If no function name is provided, downloads all functions.",
	...
	functionsDeployCmd = &cobra.Command{
		...
		Short: "Deploy a Function to Indobase",
		Long:  "Deploy a Function to the linked Indobase project.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	functionsListCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
	functionsDeleteCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
	...
	deployFlags.BoolVar(&prune, "prune", false, "Delete Functions that exist in Indobase project but not locally.")
	deployFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
	...
	downloadFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
