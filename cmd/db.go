...
import (
	...
	"github.com/Indobase/cli/internal/db/diff"
	"github.com/Indobase/cli/internal/db/dump"
	"github.com/Indobase/cli/internal/db/lint"
	"github.com/Indobase/cli/internal/db/pull"
	"github.com/Indobase/cli/internal/db/push"
	"github.com/Indobase/cli/internal/db/reset"
	"github.com/Indobase/cli/internal/db/start"
	"github.com/Indobase/cli/internal/db/test"
	"github.com/Indobase/cli/internal/utils"
	"github.com/Indobase/cli/internal/utils/flags"
	"github.com/Indobase/cli/legacy/branch/create"
	"github.com/Indobase/cli/legacy/branch/delete"
	"github.com/Indobase/cli/legacy/branch/list"
	"github.com/Indobase/cli/legacy/branch/switch_"
	legacy "github.com/Indobase/cli/legacy/diff"
...
var (
	...
	dbPullCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("Indobase db pull") + ".")
		},
	}
