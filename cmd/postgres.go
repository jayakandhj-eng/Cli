...
import (
	...
	"github.com/Indobase/cli/internal/postgresConfig/delete"
	"github.com/Indobase/cli/internal/postgresConfig/get"
	"github.com/Indobase/cli/internal/postgresConfig/update"
...
func init() {
	postgresCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Indobase project.")
