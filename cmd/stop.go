...
import (
	...
	"github.com/Indobase/cli/internal/stop"
)
...
var (
	...
	stopCmd = &cobra.Command{
		...
		Use:     "stop",
		Short:   "Stop all local Indobase containers",
...
func init() {
	...
	flags.BoolVar(&all, "all", false, "Stop all local Indobase instances from all projects across the machine.")
