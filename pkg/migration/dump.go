...
var (
	...
	InternalSchemas = []string{
		...
		// Initialised by Indobase/postgres image and owned by postgres role
		"_analytics",
		"_realtime",
		"_supavisor",
		"auth",
	...
	excludedSchemas = []string{
		...
		// "Indobase_functions",
		"Indobase_migrations",
		// TODO: Remove in a few version in favor of _Indobase internal db
		"_analytics",
		"_realtime",
		"_supavisor",
	}
	...
	allowedConfigs = []string{
		// Ref: https://github.com/Indobase/postgres/blob/develop/ansible/files/postgresql_config/supautils.conf.j2#L10
		"pgaudit.*",
		"pgrst.*",
