...
import (
	...
	"github.com/Indobase/cli/internal/hostnames"
...
func Run(ctx context.Context, projectRef string, customHostname string, fsys afero.Fs) error {
	...
	resp, err := utils.GetIndobase().V1UpdateHostnameConfigWithResponse(ctx, projectRef, api.V1UpdateHostnameConfigJSONRequestBody{
