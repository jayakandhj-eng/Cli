...
import (
	...
	"github.com/Indobase/cli/internal/orgs/list"
	"github.com/Indobase/cli/internal/utils"
	"github.com/Indobase/cli/pkg/api"
)

func Run(ctx context.Context, name string) error {
	resp, err := utils.GetIndobase().V1CreateAnOrganizationWithResponse(ctx, api.V1CreateAnOrganizationJSONRequestBody{Name: name})
	if err != nil {
