...
var allProfiles = []Profile{{
	Name:         "Indobase",
	APIURL:       "https://api.Indobase.com",
	DashboardURL: "https://Indobase.com/dashboard",
	DocsURL:      "https://Indobase.com/docs",
	ProjectHost:  "Indobase.co",
	PoolerHost:   "Indobase.com",
	...
	Name:         "Indobase-staging",
	APIURL:       "https://api.Indobase.green",
	DashboardURL: "https://Indobase.green/dashboard",
	DocsURL:      "https://Indobase.com/docs",
	ProjectHost:  "Indobase.red",
	PoolerHost:   "Indobase.green",
	ProjectRegions: []api.V1CreateProjectBodyRegion{
		api.V1CreateProjectBodyRegionApSoutheast1,
		api.V1CreateProjectBodyRegionUsEast1,
		api.V1CreateProjectBodyRegionEuCentral1,
...
func getProfilePath() (string, error) {
	...
	return filepath.Join(home, ".Indobase", "profile"), nil
}
