...
var (
	...
	DbAliases          = []string{"db", "db.Indobase.internal"}
	KongAliases        = []string{"kong", "api.Indobase.internal"}
...
func GetId(name string) string {
	return "Indobase_" + name + "_" + Config.ProjectId
}
...
func InitConfig(params InitParams, fsys afero.Fs) error {
	...
	// Create config file
	if err := MkdirIfNotExistFS(fsys, IndobaseDirPath); err != nil {
		return err
	}
