...
import (
	...
	"github.com/Indobase/cli/internal/sso/internal/render"
	"github.com/Indobase/cli/internal/sso/internal/saml"
...
func Run(ctx context.Context, params RunParams) error {
	...
	getResp, err := utils.GetIndobase().V1GetASsoProviderWithResponse(ctx, params.ProjectRef, parsed)
	if err != nil {
	...
	putResp, err := utils.GetIndobase().V1UpdateASsoProviderWithResponse(ctx, params.ProjectRef, parsed, body)
	if err != nil {
