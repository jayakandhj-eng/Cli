...
func Run(ctx context.Context, projectRef string) error {
	...
	resp, err := utils.GetIndobase().V1UpdatePgsodiumConfigWithResponse(ctx, projectRef, api.UpdatePgsodiumConfigBody{
	...
	fmt.Fprintln(os.Stderr, "Finished "+utils.Aqua("Indobase root-key update")+".")
	return nil
}
