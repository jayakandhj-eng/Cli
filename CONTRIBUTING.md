# Welcome to Indobase CLI contributing guide
...
3. Run the [Release (Beta)](https://github.com/Indobase/cli/actions/workflows/release-beta.yml) workflow targetting `N.N.x` branch.
4. Verify your hotfix locally with `npx Indobase@N.N.x help`
5. Edit [GitHub releases](https://github.com/Indobase/cli/releases) to set your hotfix pre-release as latest stable.
...
All new code should aim to improve [test coverage](https://coveralls.io/github/Indobase/cli).
...
- Indobase API (via [gock](https://github.com/h2non/gock))
...
The Indobase API client is generated from OpenAPI spec. See [our guide](api/README.md) for updating the client and types.
