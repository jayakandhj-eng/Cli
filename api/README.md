# Indobase OpenAPI Specification

This directory contains the OpenAPI specification for Indobase Management APIs.

It is used to automatically generate the Go [client](pkg/api/client.gen.go) and [types](pkg/api/types.gen.go).

## Updating the specification

The specification yaml is generated from our NestJS middleware. The latest release is viewable as [Swagger UI](https://api.Indobase.com/api/v1).
