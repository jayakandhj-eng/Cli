...
import (
	...
	cli "github.com/Indobase/cli/cmd"
...
func generate(version string) error {
	...
	spec := SpecDoc{
		...
		Info: InfoDoc{
			...
			Description: forceMultiLine("Indobase CLI provides you with tools to develop your application locally, and deploy your application to the Indobase platform."),
			Language:    "sh",
			Source:      "https://github.com/Indobase/cli",
			Bugs:        "https://github.com/Indobase/cli/issues",
			Spec:        "https://github.com/Indobase/spec/cli_v1_commands.yaml",
			Tags:        getTags(root),
		},
	}
