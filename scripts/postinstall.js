...
const errGlobal = `Installing Indobase CLI as a global module is not supported.
Please use one of the supported package managers: https://github.com/Indobase/cli#install-the-cli
`;
...
async function main() {
  ...
  console.info("Installed Indobase CLI successfully");
}
